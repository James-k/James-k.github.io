(function() {
    ...
    myConnector.getSchema = function(schemaCallback) {
        var cols = [
            ...
            { id: "ProjectEndDate", alias: "ProjectEndDate", dataType: tableau.dataTypeEnum.datetime }, 
            { id: "ProjectDuration", alias: "ProjectDuration", dataType: tableau.dataTypeEnum.datetime },
            { id: "Budget", alias: "Budget", dataType: tableau.dataTypeEnum.float }, 
            { id: "TotalDirectCost", alias: "TotalDirectCost", dataType: tableau.dataTypeEnum.float }, 
            { id: "DateSubmitted", alias: "DateSubmitted", dataType: tableau.dataTypeEnum.datetime },
            { id: "Men", alias: "Men", dataType: tableau.dataTypeEnum.int },
            { id: "Women", alias: "Women", dataType: tableau.dataTypeEnum.int }, 
            { id: "Boys", alias: "Boys", dataType: tableau.dataTypeEnum.int }, 
            { id: "Girls", alias: "Girls", dataType: tableau.dataTypeEnum.int }, 
            ...
            { id: "FieldSecurity", alias: "FieldSecurity", dataType: tableau.dataTypeEnum.string },
            { id: "Access", alias: "Access", dataType: tableau.dataTypeEnum.string },
            { id: "ActualStartDate", alias: "ActualStartDate", dataType: tableau.dataTypeEnum.datetime }, 
            { id: "ActualEndDate", alias: "ActualEndDate", dataType: tableau.dataTypeEnum.datetime }, 
            { id: "ProjectStatus", alias: "ProjectStatus", dataType: tableau.dataTypeEnum.string }, 
            { id: "ProjectStatusId", alias: "ProjectStatusId", dataType: tableau.dataTypeEnum.string },
            ...
            { id: "ProcessStatusId", alias: "ProcessStatusId", dataType: tableau.dataTypeEnum.string },
            { id: "PartnerCode", alias: "PartnerCode", dataType: tableau.dataTypeEnum.string }
        ];

        var tableSchema = {
            id: "CBPFprojectsummaryAllFunds",
            alias: "CBPF ProjectSummary All FundsAPI",
            columns: cols
        };
    ...
    myConnector.getData = function(table, doneCallback) {
        $.getJSON("https://cbpfapi.unocha.org/vo1/odata/ProjectSummary?ShowAllPooledFunds=1", function(resp) {
            var val = resp.value,
                tableData = [];
    ...
    $(document).ready(function() {
        $("#submitButton").click(function() {
            tableau.connectionName = "CBPF Project Summary All Funds API"; // This will be the data source name in Tableau
