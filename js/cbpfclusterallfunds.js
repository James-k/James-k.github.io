(function() {
    ...
    myConnector.getData = function(table, doneCallback) {
        $.getJSON("https://cbpfapi.unocha.org/vo1/odata/Cluster?ShowAllPooledFunds=1", function(resp) {
            var val = resp.value,
                tableData = [];
    ...
    $(document).ready(function() {
        $("#submitButton").click(function() {
            tableau.connectionName = "CBPF Cluster All Funds API"; // This will be the data source name in Tableau
