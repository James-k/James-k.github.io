(function() {
    ...
    myConnector.getSchema = function(schemaCallback) {
        ...
        var tableSchema = {
            id: "CBPFContributionAllFunds",
            alias: "CBPF Contribution All Funds API",
            columns: cols
        };
    ...
    myConnector.getData = function(table, doneCallback) {
        $.getJSON("https://cbpfapi.unocha.org/vo1/odata/Contribution?ShowAllPooledFunds=1", function(resp) {
            var val = resp.value,
                tableData = [];
    ...
    $(document).ready(function() {
        $("#submitButton").click(function() {
            tableau.connectionName = "CBPF Contribution All Funds API"; // This will be the data source name in Tableau
